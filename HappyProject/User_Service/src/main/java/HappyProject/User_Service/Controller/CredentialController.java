...
public class CredentialController {
    ...
    public ResponseEntity<CredentialDTO> findById(@PathVariable("credentialId") @NotBlank(message = "Input must not be blank") @Valid final String credentialId) {
        log.info("CredentialController, find all the credentials by the Id");
